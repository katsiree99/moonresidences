<template>
  ...
  >
    ...
    <div class="absolute bottom-10 left-0 right-0 text-center z-10">
      <h2 class="title">Moon Beach Villa Layouts</h2>
      <div class="w-20 h-[1.5px] bg-[#c4a47c] mt-2 mx-auto"></div>
    </div>
  </section>
...
import contactBg from "/images/gallery/villa_patong/KALIMVILLA-172.jpg";
...
const allImages = ref<any[]>([
  "layout_floor_plan_3.jpg",
  "layout_floor_plan_2.jpg",
  "layout_floor_plan_1.jpg",
]);
